...
class _EjerciciosPrincipianteScreenState extends State<EjerciciosPrincipianteScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column( // Columna principal que contiene el encabezado y los botones.
        ...
        children: [
          ...
          Container(
            ...
            child: const Column( // Columna para el título y el subtítulo.
              ...
              children: [
                ...
                SizedBox(height: 8), // Espacio vertical entre título y subtítulo.
                Text(
                  ...
                  style: AppStyles.headerSubtitleTextStyle, // Estilo del subtítulo.
                ),
              ],
            ),
          ),
          const SizedBox(height: 10), // Espacio vertical después del encabezado.
          // Botones de opciones.
          const Expanded( // El widget Expanded permite que los botones ocupen el espacio restante.
            child: Padding(
              padding: EdgeInsets.symmetric(horizontal: 56.0), // Padding horizontal para los botones.
              child: Column( // Columna para los botones.
                mainAxisAlignment: MainAxisAlignment.center, // Botones centrados verticalmente.
                children: [
                  BotonOpcion(texto: 'Enfoque piernas'), // Botón de opción para enfoque en piernas.
                  SizedBox(height: 56), // Espacio vertical entre botones.
                  BotonOpcion(texto: 'Enfoque glúteos'), // Botón de opción para enfoque en glúteos.
                  SizedBox(height: 56), // Espacio vertical entre botones.
                  BotonOpcion(texto: 'piernas gruesas'), // Botón de opción para piernas gruesas.
                ],
              ),
            ),
          ),
      ...
      bottomNavigationBar: BottomNavigationBar( // Barra de navegación inferior.
        items: const [
          BottomNavigationBarItem( // Elemento de navegación para Desafíos.
            icon: Icon(Icons.school),
            label: 'Desafíos',
          ),
          BottomNavigationBarItem( // Elemento de navegación para Clasificación.
            icon: Icon(Icons.emoji_events),
            label: 'Clasificación',
          ),
          BottomNavigationBarItem( // Elemento de navegación para Perfil.
  ...
  Widget build(BuildContext context) {
    return ElevatedButton(
      style: ElevatedButton.styleFrom(
        ...
        shape: RoundedRectangleBorder( // Forma del botón con bordes redondeados.
          borderRadius: BorderRadius.circular(12.0),
        ),
        padding: const EdgeInsets.symmetric(vertical: 30.0, horizontal: 90.0), // Padding interno del botón.
      ),
      onPressed: () {
        // Acción al presionar el botón.
        // ignore: avoid_print
        print('Seleccionaste: $texto'); // Imprime el texto del botón en la consola.
      },
      child: Text(
